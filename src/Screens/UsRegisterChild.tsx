...
const USRegisterChild: React.FC = () => {
    return (
        <React.Fragment>
                ...
                <View style={styles.BottomContainerView}>
                    ...
                    <ContentContainer style={{ width: '90%', height: '100%' }}>
                        <View style={styles.ButtonContainerView}>
                            ...
                            <AbstractButton OnPressIn={()=>navigate('USPendingApprovalPage')} txtSize={moderateScale(13)} text={'SEND REQUEST TO IMAN'} />
                        </View>
...
export default USRegisterChild
