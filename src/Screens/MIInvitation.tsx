...
import { ApproveChildModule, Header, InvitationListModule } from "../Components/Module Components";



const MIInvitation: React.FC = () => {
    return (
        <View style={styles.container}>
            <Header text={'Invitations Lists'} />
            <ContentContainer >
                ...
                <View style={styles.ScrollContainerView}>
                    <ScrollView showsVerticalScrollIndicator={false}>
                        {[0, 0, 0, 0, 0, 0, 0].map((val, index) => {
                            return <InvitationListModule key={index} />
                        })
                        }
                    </ScrollView>
                </View>
