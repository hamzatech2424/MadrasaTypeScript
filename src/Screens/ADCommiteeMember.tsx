...
const ADCommiteeMember: React.FC = () => {
    return (
        <React.Fragment>
            <View style={styles.container}>
                ...
                <View style={styles.TopContainerView}>
                    <Header text={'Add Committee Members'} />
                    ...
                    <ContentContainer style={{ width: '90%', height: '100%' }}>
                        ...
                        >
                            ...
                            >
                                ...
                                <View style={styles.textInputContainerView}>
                                    <Text style={{fontSize:moderateScale(10)}}>Voted Date</Text>
                                    <AbstractTextInput
                                        // valueChange={email}
                                        // handleChange={(txt)=>setEmail(txt)}
                                        placeHolderTextColor={'lightgrey'}
                ...
                <View style={styles.BottomContainerView}>
                    ...
                    <ContentContainer style={{ width: '90%', height: '100%' }}>
                        <View style={styles.ButtonContainerView}>
                            ...
                            <AbstractButton txtSize={moderateScale(12)} width={'45%'} height={'50%'} text={'Add'}  />
                            <AbstractButton txtSize={moderateScale(12)} width={'45%'} disabled height={'50%'} text={'Delete'} />
                        </View>
...
export default ADCommiteeMember
