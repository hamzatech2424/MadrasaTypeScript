...
const ADEditService:React.FC = () => {
    return (
        <View style={styles.container}>
            <Header text={'Edit Service'} />
            ...
            <ContentContainer>
              ...
              <AbstractButton height={moderateScale(38)} txtSize={moderateScale(10)} text={'ADD SERVICE'} />
