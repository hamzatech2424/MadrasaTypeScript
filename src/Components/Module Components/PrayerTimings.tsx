...
const PrayerTimings: React.FC<Props> = ({ TimingObject, PrayerStartObject,height,width }) => {
        ...
        <View style={{ width: defaulWidth, height: defaultHeight, backgroundColor: 'white', alignSelf: 'center', flexDirection: 'column', borderRadius: 3, borderColor: 'lightgrey', borderWidth: 0.5 }}>
            ...
            <View style={{ width: '100%', height: '35%', flexDirection: 'row' }}>
                <TouchableOpacity
                    ...
                    style={{ width: '50%', height: '100%', backgroundColor: shift ? '#3CBA92' : 'green', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={() => { setShift(false) }}
                    style={{ width: '50%', height: '100%', backgroundColor: shift ? 'green' : '#3CBA92', justifyContent: 'center', alignItems: 'center' }}>

                    <Text style={{ textAlign: 'center', fontSize: 14, color: 'white' }}>Prayers Start Times</Text>
            ...
            <View style={{width: '100%', height: '37%', flexDirection: 'row', borderTopColor: 'lightgrey', borderTopWidth: 0.8 }}>
                <View style={{ width: '18.1%', height: '100%', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', borderRightColor: 'lightgrey', borderLeftWidth: 0.5,borderRightWidth: 0.5,borderLeftColor:'white' }}>
                    <Text style={{ fontSize: 11 }} >Prayers</Text>
                    <Text style={{ fontSize: 11, color: 'grey' }} >Timing</Text>
                </View>

                <View style={{ width: '16.6%', height: '100%', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', borderRightColor: 'lightgrey', borderLeftWidth: 0.5 }}>
