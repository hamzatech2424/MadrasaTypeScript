...
const HeaderMyDonations: React.FC<Props> = ({text,OnPressIn}):JSX.Element=> {
            ...
            onPress={OnPressIn}
                    ...
                    <View style={{ width: 30, height: 30, borderRadius: 15, backgroundColor: '#3CBA92', justifyContent: 'center', alignItems: 'center' }}>
                       <View style={{width:'40%',height:'50%'}}>
                           <Image source={require('../../Assets/images/Icon1.png')} style={{width:'100%',height:'100%'}} />
                       </View>
...
export default HeaderMyDonations