...
const SuggestionListModule: React.FC = () => {
    return (
        <View style={{ backgroundColor: 'white', width: '100%', height: 115, flexDirection: 'row', borderWidth: 1, borderColor: 'lightgrey' }}>
            ...
            <View style={{ width: '80%', height: '100%', justifyContent: 'center' }}>
                <View style={{ width: '85%', height: '80%' }}>
                    ...
                    <Text style={{ color: 'black', fontSize: 10 }}>Suggestion:</Text>
...
export default SuggestionListModule